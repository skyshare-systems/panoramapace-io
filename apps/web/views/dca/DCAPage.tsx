...
import ModalAutoInvest from "./ModalAutoInvest";
...
const DCAPage = () => {
  ...
  return (
    <>
      {showModal === true && <ModalAutoInvest isOpen={setShowModal} />}
          ...
          <div className="flex flex-col gap-8 items-start justify-start grow w-full">
            <div className="flex flex-wrap justify-between items-center grow w-full gap-2">
              ...
              <button
                ...
                className="button-gradient py-3 px-4 flex items-center gap-2 ty-title text-white-80 rounded-lg hover:opacity-50 duration-200"
              >
                <svg
